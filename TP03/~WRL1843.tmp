...
Une fois les log étudier, il faut taper la commande suivante : __ cat ~/.bash_history__. La commande va permettre de connaitre les différentes commandes taper précédemment, le résultat est le suivant :
